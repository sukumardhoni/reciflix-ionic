...
.controller('grocerysCtrl', function ($scope, Grocery, $stateParams, $ionicLoading, Authentication, $ionicPopup, singleGrocery, $localStorage, $http, $ionicHistory, $ionicModal, $ionicListDelegate) {
